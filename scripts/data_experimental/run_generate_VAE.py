...
from data_generator_VAE import *
...
def main():
    ...
    elem_params, elem_s = line_to_elem_params_and_s(line, N=32)
    ...
    data["elem_params"] = elem_params.astype(np.float32)  # [32,7]
    data["elem_s"] = elem_s.astype(np.float32)            # [32]
