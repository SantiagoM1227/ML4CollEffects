#!/bin/bash
#SBATCH --job-name=VAE_GEN
#SBATCH --output=/pbs/home/s/smartinez/ML4CollEffects/outputs/VAE_GEN-%j.out
#SBATCH --error=/pbs/home/s/smartinez/ML4CollEffects/outputs/VAE_GEN-%j.err
#SBATCH --ntasks=1
...
python -u /pbs/home/s/smartinez/ML4CollEffects/scripts/data_experimental/run_generate_VAE.py