#!/bin/bash
#SBATCH --job-name=EVAL_VAESSNO
#SBATCH --output=/pbs/home/s/smartinez/ML4CollEffects/outputs/demo006-eval-vae-%j.out
#SBATCH --error=/pbs/home/s/smartinez/ML4CollEffects/outputs/demo006-eval-vae-%j.err
#SBATCH --ntasks=1
...
export VAE_CKPT="${VAE_CKPT:-$DEMO006_ROOT/output/stage1_vae/vae_best.pt}"
export OUT_DIR="${OUT_DIR:-$DEMO006_ROOT/output/stage1_vae/eval}"

mkdir -p "$OUT_DIR"

echo "=== demo-run-006 EVAL VAE ==="
