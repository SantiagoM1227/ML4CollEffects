#!/bin/bash
#SBATCH --job-name=demo006-train-vae
#SBATCH --output=/pbs/home/s/smartinez/ML4CollEffects/outputs/demo006-train-vae-%j.out
#SBATCH --error=/pbs/home/s/smartinez/ML4CollEffects/outputs/demo006-train-vae-%j.err
#SBATCH --ntasks=1
...
# ---- paths ----
export DATASET_PATH="/pbs/home/s/smartinez/ML4CollEffects/data/neural/neural_xsuite_dataset_2026-05-26T16:24:30.npz"
...
# where to save ckpt
export OUTDIR="$DEMO006_ROOT/output/stage1_vae"
mkdir -p "$OUTDIR"
